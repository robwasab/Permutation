...
#
# ActiveState ActiveTcl 8.5.13.296436 OS X/Leopard/i386-x86_64, Mon Nov 19 21:23:00 PST 2012
#
...
namespace eval ::activestate {
	...
	buildtime,sec {1353388980}
	buildtime,fmt {Mon Nov 19 21:23:00 PST 2012}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.13.296436 OS X/Leopard/i386-x86_64 @ Mon Nov 19 21:23:00 PST 2012 / normal}
    }
}
